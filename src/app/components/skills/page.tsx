  ...
  return (
    <div id="skills" className="relative z-50 py-24 lg:py-48 overflow-hidden ">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
        <div className="flex flex-col items-center mb-16 lg:mb-24">
          <SectionReveal direction="down">
            <div className="flex flex-col items-center gap-4">
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter text-center px-2">
                The{" "}
        ...
        <div className="flex flex-col gap-4 sm:gap-6 lg:gap-8 relative w-full overflow-hidden max-w-[100vw]">
          {/* Gradient Masks */}
