...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-12 lg:mb-32">
        <div className="flex items-center w-full justify-center px-4">
          <span className="w-12 md:w-24 h-[2px] bg-gradient-to-r from-transparent to-red-600"></span>
          <span className="bg-[#050505] border border-red-600/30 w-fit text-white p-2 px-4 md:p-3 md:px-8 text-lg md:text-2xl font-bold rounded-full shadow-[0_0_20px_rgba(220,38,38,0.2)] whitespace-nowrap">
            Projects Showcase
          </span>
          <span className="w-12 md:w-24 h-[2px] bg-gradient-to-l from-transparent to-red-600"></span>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="flex flex-col items-center gap-12 lg:gap-20">
          ...
          <Link
            href="https://github.com/NirajDN?tab=repositories"
            target="_blank"
